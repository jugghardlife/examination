...
<head>
	...
	<title>添加学生信息</title>
	<link rel="stylesheet" href="/examination/Public/admin/css/see.css">
	<link rel="stylesheet" href="/examination/Public/admin/css/addStudentA.css">
...
<body class="see_body">
	<div class="content_top">
		...
		<div class="content_top_content">
			<div class="username"><span>管理：</span><p><?php echo (session('username')); ?></p></div>
	...
	<script>
		$(".stulogin_in").click(function(){
			...
			$.ajax({
				url: "<?php echo U('Admin/Index/addStuA');?>",
				data: {
