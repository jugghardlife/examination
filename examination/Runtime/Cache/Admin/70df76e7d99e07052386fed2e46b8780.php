...
<body>
	...
	<div class="revPsw_box">
		...
		<div class="revPsw_content">
			<div class="revPsw_ind">
				<span>账户:</span>
				<input type="text" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" onkeyup="value=value.replace(/[^\w\/]/ig,'')" placeholder="请输入您的账户" maxlength="15" class="stuNum">
			</div>
			<div class="revPsw_ind">
				<span>旧密码:</span>
	...
	<script>
		$(".stulogin_in").click(function(e){
			...
			$.ajax({
				url: "<?php echo U('Admin/index/modPsw');?>",
				data: {
						'stuNum': stuNum,
						'oldPsw':oldPsw,
						'newPsw':newPsw,
