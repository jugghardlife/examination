...
<body class="stuScore_body">
	...
	<div class="stuScore_del_bgc">
		<div class="stuScore_del_img">
			<img src="/examination/Public/public/images/d.svg" alt="">
		</div>
		...
		<div class="stuScore_content">
			...
			<div class="top_back">
				...
				<div class="stuScore_adminsScore">
					<a href="<?php echo U('Admin/index/changeClassPerson');?>">修改分班</a>
			            	...
			            	"<div class='see_content_top'>"+
			            		...
			            		"<div class='change_class'><span>班级:</span>"+
			            			"<select>"+
			            				...
			            				"<option value ='4' class='class4'>装备1</option>"+
			            				"<option value ='0' class='class5'>未分班</option>"+
			            			"</select>"+
			            		"</div>"+
