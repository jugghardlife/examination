...
<head>
	...
	<link rel="stylesheet" href="/examination/Public/stu/css/revPsw.css">
	...
	<div class="revPsw_box">
		...
		<div class="revPsw_content">
			<div class="revPsw_ind">
				<span>学号:</span>
				<input type="text" onKeyUp="value=value.replace(/[^\d]/g,'')" onafterpaste="this.value=this.value.replace(/[^\d]/g,'')" placeholder="请输入您的学号" maxlength="15">
			</div>
			<div class="revPsw_ind">
				<span>旧密码:</span>
				<input type="password"  placeholder="请输入您的密码" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" onkeyup="value=value.replace(/[^\w\/]/ig,'')" maxlength="15">
			</div>
			<div class="revPsw_ind">
				<span>新密码:</span>
				<input type="password"  placeholder="请输入您的密码" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" onkeyup="value=value.replace(/[^\w\/]/ig,'')" maxlength="15">
