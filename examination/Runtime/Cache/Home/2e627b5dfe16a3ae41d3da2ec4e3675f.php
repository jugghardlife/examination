	...
	<div class="stuchoose_box">
		...
		<div class="stuchoose_content">
			<div class="stuchoose_content_top">
				<div class="stuchoose_content_top_left"><a href="<?php echo U('Stu/fill');?>">填报志愿</a></div>
				<div class="stuchoose_content_top_right"><a href="<?php echo U('Stu/see');?>">查看个人信息</a></div>
			</div>
			<div class="stuchoose_content_bottom">
				<div class="stuchoose_content_bottom_left"><a href="<?php echo U('Stu/stuScore');?>">成绩排行</a></div>
				<div class="stuchoose_content_bottom_right"><a href="<?php echo U('Stu/revPsw');?>">修改密码</a></div>
			</div>	
		</div>
	</div>
